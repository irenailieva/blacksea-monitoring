...
def cleanup_labels(val):
    ...
    Гарантира, че моделите се обучават върху вътрешни класове 0, 1, 2, 3.
    0: Пясък / Плитка вода (Абиотични)
    1: Водорасли / Скали (Растителност)
    2: Дълбока вода
    3: Морски фитопланктон
    """
    if val == 0: return 0 
    if val == 1: return 1 
    if val == 2: return 2 
...
def train():
    ...
    class_names = ['Абиотични (Пясък)', 'Растителност', 'Дълбока вода', 'Морски фитопланктон'] # 0, 1, 2, 3
